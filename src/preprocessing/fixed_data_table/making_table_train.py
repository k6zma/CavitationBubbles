...
df_12_5_alcohol.to_csv(
    "data/fixed_data/tmp_csv_train/12.5_alcohol.csv", index=False)
...
df_25_alcohol.to_csv(
    "data/fixed_data/tmp_csv_train/25_alcohol.csv", index=False)
...
df_50_alcohol.to_csv(
    "data/fixed_data/tmp_csv_train/50_alcohol.csv", index=False)
...
df_75_alcohol.to_csv(
    "data/fixed_data/tmp_csv_train/75_alchol.csv", index=False)
