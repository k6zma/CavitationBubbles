...
df_12_5_alcohol.to_csv("data/fixed_data/tmp_csv_test/12.5_alcohol.csv", index=False)
...
df_25_alcohol.to_csv("data/fixed_data/tmp_csv_test/25_alcohol.csv", index=False)
...
df_50_alcohol.to_csv("data/fixed_data/tmp_csv_test/50_alcohol.csv", index=False)
...
df_96_alcohol.to_csv("data/fixed_data/tmp_csv_test/96_alcohol.csv", index=False)
